...
pathname_mbmf1 = '/home/anagabandi/rllab/data/local/experiment/'+ 'run_'+ str(run_num1)+'_std'+str(std_on_mlp_policy) + '_run' +str(mbmf_filename_numbers[0])
pathname_mbmf2 = '/home/anagabandi/rllab/data/local/experiment/'+ 'run_'+ str(run_num2)+'_std'+str(std_on_mlp_policy) + '_run' +str(mbmf_filename_numbers[1])
pathname_mbmf3 = '/home/anagabandi/rllab/data/local/experiment/'+ 'run_'+ str(run_num3)+'_std'+str(std_on_mlp_policy) + '_run' +str(mbmf_filename_numbers[2])

#mf trpo runs
pathname_mf1 = '/home/anagabandi/rllab/data/local/experiment/'+ 'agent_'+str(which_agent)+ mf_filename_numbers[0]
pathname_mf2 = '/home/anagabandi/rllab/data/local/experiment/'+ 'agent_'+str(which_agent)+ mf_filename_numbers[1]
pathname_mf3 = '/home/anagabandi/rllab/data/local/experiment/'+ 'agent_'+str(which_agent)+ mf_filename_numbers[2]
...
ax.hlines(mf_mean.max(), mb_num_data[0], mf_num_data[-1], color='k', linestyle='--')
